...
/*-------------------------- SPI CONFIG BEGIN --------------------------*/
    ...
    #define SPI3_CS_ALTERNATE       GPIO_FUNCTION_4
    #define SPI3_SCK_PORT           GPIOB
    #define SPI3_SCK_PIN            GPIO_PIN_13
    #define SPI3_SCK_ALTERNATE      GPIO_FUNCTION_4
    #define SPI3_MISO_PORT          GPIOB
    #define SPI3_MISO_PIN           GPIO_PIN_14
    #define SPI3_MISO_ALTERNATE     GPIO_FUNCTION_4
    #define SPI3_MOSI_PORT          GPIOB
    #define SPI3_MOSI_PIN           GPIO_PIN_15
    #define SPI3_MOSI_ALTERNATE     GPIO_FUNCTION_4
    #define SPI3_WP_PORT            GPIOC
    #define SPI3_WP_PIN             GPIO_PIN_7
    #define SPI3_WP_ALTERNATE       GPIO_FUNCTION_2
    #define SPI3_HOLD_PORT          GPIOC
    #define SPI3_HOLD_PIN           GPIO_PIN_6
    #define SPI3_HOLD_ALTERNATE     GPIO_FUNCTION_2

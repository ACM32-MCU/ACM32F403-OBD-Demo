...
static rt_err_t _function_enable(ufunction_t func)
{
...
#endif	
	data->geometry.bytes_per_sector = 1024;

    data->ep_in->buffer = (rt_uint8_t*)rt_malloc(data->geometry.bytes_per_sector);
	rt_kprintf("data->ep_in[%08X]->buffer %08X\n", (rt_uint32_t)data->ep_in, (rt_uint32_t)data->ep_in->buffer);
	...
	rt_kprintf("data->ep_out[%08X]->buffer %08X\n", (rt_uint32_t)data->ep_out, (rt_uint32_t)data->ep_out->buffer);

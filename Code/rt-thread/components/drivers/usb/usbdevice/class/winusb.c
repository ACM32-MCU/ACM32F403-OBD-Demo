...
{
    RT_DEBUG_LOG(RT_DEBUG_USB, ("_ep_out_handler %08X %08X", func, size));
...
{                
    RT_DEBUG_LOG(RT_DEBUG_USB, ("_ep_in_handler %08X %08X", func, size));
    winusb_device_t winusb_device = (winusb_device_t)func->user_data;
...
{        
    RT_DEBUG_LOG(RT_DEBUG_USB, ("_ep0_cmd_handler %08X", size));
...
{            
    RT_DEBUG_LOG(RT_DEBUG_USB, ("_ep0_cmd_read %08X", func));
    winusb_device_t winusb_device = (winusb_device_t)func->user_data;
    cmd_func = func;
...
{
    rt_kprintf("_interface_handler %02X\n", setup->bRequest);
